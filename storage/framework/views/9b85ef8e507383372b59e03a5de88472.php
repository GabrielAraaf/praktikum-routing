...
<body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/logo-white.svg')); ?>" alt="image">
            </a>
            <!-- Navbar Toggler -->
    ...
    text-white"></i>
                ...
                <div class="col-lg-6">
                    <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/bs-icons.png')); ?>" alt="image">
                </div>
            </div>
        </div>
    </div>
    ...
    text-white"></i>
                ...
                <div class="col-lg-6">
                    <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/bs-themes.png')); ?>" alt="image">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/logo-black.svg')); ?>" alt="image">
...
</html><?php /**PATH C:\Users\klikm\framework\resources\views/view_prak.blade.php ENDPATH**/ ?>